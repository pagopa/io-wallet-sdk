...
describe("WalletProvider v1.3 - version routing", () => {
...
describe("WalletProvider v1.3 - version mismatch", () => {
  it("should throw WalletProviderError when V1_0 config receives V1_3 options", async () => {
    const provider = new WalletProvider(
      new IoWalletSdkConfig({
        itWalletSpecsVersion: ItWalletSpecsVersion.V1_0,
      }),
  ...
  it("should throw WalletProviderError when V1_3 config receives V1_0 options", async () => {
    const provider = new WalletProvider(
      new IoWalletSdkConfig({
        itWalletSpecsVersion: ItWalletSpecsVersion.V1_3,
      }),
...
describe("WalletProvider v1.3 - v1.3 routing", () => {
